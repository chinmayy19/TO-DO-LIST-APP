...
function CreateToDoItems() {
  ...
  function ReadToDoItems() {
    todo.forEach((element) => {
      ...
      ${
        style === ""
          ? '<img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="images/draw.png" />'
          : ""
      }
      <img class="delete todo-controls" onclick="DeleteToDoItems(this)" src="images/bin.png" /></div></div>`;
      li.innerHTML = todoItems;
      listItems.appendChild(li);
    });
  }
